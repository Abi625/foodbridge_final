...
FoodBridge/ │ ├── index.html # Landing page ├── login.html # Login page (Donor/Receiver) ├── donor_post.html # Donor food posting page ├── receiver_view.html # Receiver dashboard (if included) ├── style.css # Styling ├── firebase-init.js # Firebase configuration └── assets/ # Images (food items)
...
🔥 Firebase Setup (Optional) To enable real-time database: Create a project in Firebase Enable Firestore Database Add your Firebase config in firebase-init.js Ensure Firestore rules allow read/write
...
🤖 AI-based food priority prediction 🗺️ Map-based tracking 📊 Analytics dashboard
